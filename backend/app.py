...
from routes import auth, dashboard, transactions, health, analytics, recommendations, insights, chat, experience
...
def create_app(config=None):
    ...
    init_db(app)
    for module in (auth, dashboard, transactions, health, analytics, recommendations, insights, chat, experience):
